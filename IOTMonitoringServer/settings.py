...
ALLOWED_HOSTS = ["localhost", "44.197.208.254"]#["localhost", "ip.maquina.visualizador"]
...
DATABASES = {
    "default": {
        ...
        "HOST": "13.220.17.237", #"ip.maquina.db",  # Dirección IP de la base de datos
...
MQTT_HOST = "3.237.179.129" #"ip.maquina.mqtt"
